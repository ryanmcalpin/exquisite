...
public class FirebaseInviteViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bindGame(final Game game) {
        ...
        AppCompatImageView acceptButton = (AppCompatImageView) mView.findViewById(R.id.acceptButton);
        AppCompatImageView declineButton = (AppCompatImageView) mView.findViewById(R.id.declineButton);
